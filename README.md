...
- [ ] **Bildrechte klären.** Die Fotos in `assets/img/` sehen nach Händler-/Stock-
      ...
      `denon-prime-go.webp` (Motiv von
      `Denon-DJ-Prime-Go-gebraucht-3-768x768.webp`; seit 2026-08-31 mit
      angehobenem Weisspunkt: >=248 -> 255, damit der Studio-Hintergrund an den
      Kanten in das Weiss des Hero uebergeht statt eine graue Naht zu ziehen)
      ist wasserzeichenfrei, die Herkunft offen.
